_Last Updated: 2026-06-14T12:32:32.996826-05:00_
...
| `input_datetime.home_timestamp` | **Home Timestamp** | 2026-06-13 12:59:11 | has_date=True, has_time=True |
...
| `input_datetime.last_door_open` | **Last Door Open** | 2026-06-14 11:47:05 | has_date=True, has_time=True |
...
| `input_text.alarm_music` | **Alarm Music** | No My likes |  |
...
| `counter.door_stuck` | **Door Stuck** | 19 | min=, max= |
...
<details><summary><b>Binary_sensor (69)</b></summary>
...
<details><summary><b>Button (36)</b></summary>
...
| `button.bedroom_lamp_identify` | Bedroom Lamp Identify | unavailable |
...
| `button.hue_bulb_new_identify` | Hue bulb new Identify | unknown |

| `button.living_room_favorite_current_song` | Living Room Favorite current song | unavailable |
...
| `device_tracker.govee_h5074_1012` | govee h5074 1012 | unavailable |

| `device_tracker.gvh5075_822d` | gvh5075 822d | unavailable |
...
| `event.all_echo_voice_event` | All Echo Voice event | unavailable |

| `event.backup_automatic_backup` | Backup Automatic backup | 2026-06-14T10:05:22.184+00:00 |

| `event.bedroom_blake_s_echo_pop_voice_event` | Blake's Echo Pop Voice event | unknown |

| `event.blake_s_echo_spot_voice_event` | Blake's Echo Spot Voice event | 2026-06-06T14:03:05.467+00:00 |
...
| `light.broken` | Broken | unavailable |
...
| `media_player.living_room` | Living Room | unavailable |
...
| `notify.blake_s_echo_spot_speak` | Blake's Echo Spot Speak | 2026-06-03T14:10:15.586559+00:00 |

| `notify.blakes_iphone` | Blakes iPhone | 2026-06-14T17:18:24.242953+00:00 |

| `notify.ipad` | iPad | unknown |

| `notify.rachels_phone` | Rachels Phone | unknown |
...
<details><summary><b>Number (86)</b></summary>
...
| `number.bedroom_lamp_start_up_color_temperature` | Bedroom Lamp Start-up color temperature | unavailable |

| `number.bedroom_lamp_start_up_current_level` | Bedroom Lamp Power-on level | unavailable |
...
| `number.hue_bulb_new_power_on_level` | Hue bulb new Power-on level | 254 |

| `number.hue_bulb_new_start_up_color_temperature` | Hue bulb new Start-up color temperature | 366 |
...
| `scene.all_lights` | All Lights | 2026-06-13T18:04:29.270525+00:00 |

| `scene.all_off` | All Off | 2026-06-13T17:38:00.123121+00:00 |

| `scene.bedroom_lights_off` | Bedroom Lights Off | 2026-06-13T19:37:34.969160+00:00 |

| `scene.dimmed` | Dimmed | 2026-06-05T20:03:38.815143+00:00 |

| `scene.full_lamp` | Full Lamp | 2026-06-14T16:04:31.295533+00:00 |

| `scene.goodnight_scene` | Goodnight | 2026-06-14T12:03:03.528591+00:00 |

| `scene.im_awake` | I’m Awake | 2026-04-09T17:49:30.369497+00:00 |

| `scene.lights_off_except_bedroom` | Lights off except bedroom | 2026-06-14T16:04:31.156133+00:00 |

| `scene.night_light` | Night Light | 2025-09-26T00:17:04.739409+00:00 |

| `scene.set_my_room` | Set My Room | 2026-06-02T23:12:22.536759+00:00 |

| `scene.thermostat_away` | Thermostat Away | 2026-06-12T17:33:14.835177+00:00 |
...
<details><summary><b>Select (19)</b></summary>
...
| `select.bedroom_lamp_start_up_behavior` | Bedroom Lamp Power-on behavior | unavailable |
...
| `select.hue_bulb_new_power_on_behavior` | Hue bulb new Power-on behavior | On |
...
| `sensor.0102000000_c5b1_estimated_distance` | Estimated distance | unavailable |

| `sensor.4_26af_estimated_distance` | Estimated distance | unavailable |

| `sensor.4_7e42_estimated_distance` | Estimated distance | unavailable |

| `sensor.4_eda2_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.a_expansion_attic_temperature` | A expansion attic Temperature | 75.02 |
...
| `sensor.akamatis_presence_sensor_b24c50_g7_still_energy` | Akamatis Presence Sensor b24c50 g7 still energy | 5.0 |

| `sensor.akamatis_presence_sensor_b24c50_g8_move_energy` | Akamatis Presence Sensor b24c50 g8 move energy | 4.0 |

| `sensor.akamatis_presence_sensor_b24c50_g8_still_energy` | Akamatis Presence Sensor b24c50 g8 still energy | 6.0 |
...
| `sensor.aqara_fp300_illuminance` | Aqara FP300 Illuminance | 5 |

| `sensor.aqara_fp300_target_distance` | Aqara FP300 Target distance | unknown |

| `sensor.aqara_fp300_temperature` | Aqara FP300 Temperature | 67.73 |

| `sensor.backup_backup_manager_state` | Backup Backup Manager state | idle |

| `sensor.backup_last_attempted_automatic_backup` | Backup Last attempted automatic backup | 2026-06-14T09:58:15+00:00 |

| `sensor.backup_last_successful_automatic_backup` | Backup Last successful automatic backup | 2026-06-14T10:05:21+00:00 |

| `sensor.backup_next_scheduled_automatic_backup` | Backup Next scheduled automatic backup | 2026-06-15T09:55:33+00:00 |

| `sensor.bathroom_humidity` | Bathroom Humidity | 59.73 |
...
| `sensor.bathroom_temperature` | Bathroom Temperature | 69.926 |
...
| `sensor.bed_presence_bb8594_left_pressure` | Bed Pressure Sensor Left Pressure | 95.0225067138672 |

| `sensor.bed_presence_bb8594_right_pressure` | Bed Pressure Sensor Right Pressure | 85.8189010620117 |

| `sensor.bed_presence_bb8594_uptime` | Bed Pressure Sensor Uptime | 3591806.5 |
...
| `sensor.bedroom_ceiling_fan_energy_consumed` | Bedroom Ceiling Fan Energy consumed | 20.531303 |

| `sensor.blake_foster30_gmail_com_total_available_storage` | blake.foster30@gmail.com Total available storage | 5120.0 |

| `sensor.blake_foster30_gmail_com_used_storage` | blake.foster30@gmail.com Used storage | 270.324054744095 |
...
| `sensor.bthome_sensor_3370_packet_id` | Motion 1 - Shelly Packet Id | 253 |

| `sensor.bthome_sensor_3370_signal_strength` | Motion 1 - Shelly Signal Strength | -68 |

| `sensor.c_expansion_attic_humidity` | C Expansion attic Humidity | 35 |

| `sensor.c_expansion_attic_temperature` | C Expansion attic Temperature | 87.26 |
...
| `sensor.everything_presence_lite_922d28_illuminance` | Everything Presence Lite Illuminance | 1.24507856369019 |
...
| `sensor.everything_presence_lite_922d28_target_1_angle` | Everything Presence Lite Target 1 Angle | -50.9293441772461 |

| `sensor.everything_presence_lite_922d28_target_1_distance` | Everything Presence Lite Target 1 Distance | 18.8643075537494 |
...
| `sensor.everything_presence_lite_922d28_target_1_x` | Everything Presence Lite Target 1 X | 2.59842519685039 |

| `sensor.everything_presence_lite_922d28_target_1_y` | Everything Presence Lite Target 1 Y | 18.6614173228346 |

| `sensor.everything_presence_lite_922d28_target_2_angle` | Everything Presence Lite Target 2 Angle | 15.0451965332031 |

| `sensor.everything_presence_lite_922d28_target_2_distance` | Everything Presence Lite Target 2 Distance | 176.238042876476 |
...
| `sensor.everything_presence_lite_922d28_target_2_x` | Everything Presence Lite Target 2 X | -149.527559055118 |

| `sensor.everything_presence_lite_922d28_target_2_y` | Everything Presence Lite Target 2 Y | 93.2677165354331 |

| `sensor.everything_presence_lite_922d28_target_3_angle` | Everything Presence Lite Target 3 Angle | -1.63233649730682 |

| `sensor.everything_presence_lite_922d28_target_3_distance` | Everything Presence Lite Target 3 Distance | 121.624159925566 |
...
| `sensor.everything_presence_lite_922d28_target_3_x` | Everything Presence Lite Target 3 X | -80.3543307086614 |

| `sensor.everything_presence_lite_922d28_target_3_y` | Everything Presence Lite Target 3 Y | 91.2598425196851 |
...
| `sensor.front_door_sensor_illuminance` | Front Door Sensor Illuminance | 8.0 |

| `sensor.front_door_sensor_rotation` | Front Door Sensor Rotation | 0.0 |

| `sensor.govee_h5074_1012_estimated_distance` | Estimated distance | unavailable |

| `sensor.govee_to_mqtt_version` | Version | unavailable |

| `sensor.gvh5075_822d_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.lw_ivu_ecf4_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.main_lights_this_month_s_consumption` | Main Lights This month's consumption | 0.387 |
...
| `sensor.niu_kqi_cf5e_estimated_distance` | Estimated distance | unavailable |

| `sensor.niu_kqi_fcd3_estimated_distance` | Estimated distance | unavailable |

| `sensor.niukqi_1f3e_estimated_distance` | Estimated distance | unavailable |

| `sensor.openweathermap_cloud_coverage_2` | OpenWeatherMap Cloud coverage | 90 |

| `sensor.openweathermap_condition_2` | OpenWeatherMap Condition | cloudy |

| `sensor.openweathermap_dew_point_2` | OpenWeatherMap Dew point temperature | 58.658 |

| `sensor.openweathermap_feels_like_temperature_2` | OpenWeatherMap Apparent temperature | 73.724 |
...
| `sensor.openweathermap_temperature_2` | OpenWeatherMap Temperature | 73.868 |

| `sensor.openweathermap_uv_index_2` | OpenWeatherMap UV index | 9.02 |
...
| `sensor.openweathermap_wind_bearing_2` | OpenWeatherMap Wind direction | 19 |

| `sensor.openweathermap_wind_gust_2` | OpenWeatherMap Wind gust speed | 12.9965998568361 |

| `sensor.openweathermap_wind_speed_2` | OpenWeatherMap Wind speed | 11.0057265569077 |
...
| `sensor.rivian_phone_key_3528_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_phone_key_8e96_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_phone_key_9e27_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_phone_key_b167_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_phone_key_d403_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_phone_key_ec7f_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_phone_key_ed6d_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_phone_key_edb6_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_sensor_1_c68e_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_sensor_2_9210_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_sensor_3_adc1_estimated_distance` | Estimated distance | unavailable |

| `sensor.rivian_sensor_3_bb9a_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.rivian_sensor_4_7b97_estimated_distance` | Estimated distance | unavailable |

| `sensor.s02c178131a224f0cc_1887_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.s441ac91699791ed5c_0bb9_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.sa123e3d8d7a762bfc_08af_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.shelly_ceiling_fan_energy` | Bedroom Ceiling Fan Energy | 20.531303 |

| `sensor.shelly_ceiling_fan_power` | Bedroom Ceiling Fan Power | 13.9 |

| `sensor.shelly_ceiling_lights_energy` | Bedroom Ceiling Lights Energy | 18.033249 |
...
| `sensor.shellyplugusg4_58e6c509a06c_energy` | shellyplugusg4-58e6c509a06c Energy | 4.952397 |
...
| `sensor.slzb_mr1_zigbee_chip_temp_2` | SLZB-MR1 Zigbee chip temp | 110.012 |

| `sensor.slzb_mr1_zigbee_type` | SLZB-MR1 Zigbee type | thread |

| `sensor.slzb_mr1_zigbee_type_2` | SLZB-MR1 Zigbee type | coordinator |

| `sensor.sun_next_dawn` | Sun Next dawn | 2026-06-15T10:05:14+00:00 |

| `sensor.sun_next_dusk` | Sun Next dusk | 2026-06-15T02:01:16+00:00 |

| `sensor.sun_next_midnight` | Sun Next midnight | 2026-06-15T06:03:23+00:00 |

| `sensor.sun_next_noon` | Sun Next noon | 2026-06-14T18:03:01+00:00 |

| `sensor.sun_next_rising` | Sun Next rising | 2026-06-15T10:37:45+00:00 |

| `sensor.sun_next_setting` | Sun Next setting | 2026-06-15T01:28:45+00:00 |
...
| `sensor.telematic_390191_c5aa_estimated_distance` | Estimated distance | unavailable |
...
| `sensor.third_reality_inc_3rvs01031z_battery` | Vibration Sensor 1 Battery | 71.5 |
...
| `sensor.tirelinc_b3a6_estimated_distance` | Estimated distance | unavailable |

| `sensor.uptime` | Uptime | 2026-06-05T17:13:52+00:00 |

| `sensor.vibration_2_third_reality_battery` | Vibration Sensor 2 Battery | 21.5 |
...
| `switch.blake_s_echo_spot_shuffle_switch` | Blake's Echo Spot Shuffle | off |
...
| `update.bedroom_lamp_firmware` | Bedroom Lamp Firmware | unavailable |
...
| `update.hue_bulb_new_firmware` | Hue bulb new Firmware | unknown |
...
| `update.simple_swipe_card_update` | Simple Swipe Card Update | on |
