...
| `sensor.50_onn_roku_tv_active_app` | Bedroom TV Active app |

| `sensor.50_onn_roku_tv_active_app_id` | Bedroom TV Active app ID |
...
| `sensor.bathroom_light_auto_off_at` | Bathroom Light Auto-off at |
...
| `scene.all_off` | All Off |

| `scene.dimmed` | Dimmed |

| `scene.full_lamp` | Full Lamp |

| `scene.goodnight_scene` | Goodnight |

| `scene.im_awake` | I’m Awake |

| `scene.lights_off` | Bedroom Lights Off |

| `scene.night_light` | Night Light |
...
| `script.generate_entities_readme` | Generate Entities README (Grouped) |
...
| `automation.bathroom_with_closet` | Closet light triggers bathroom light |

| `automation.flic_single` | Flic Button |

| `automation.lamp_log_test` | _Probe - Lamp state latency (ms) |
...
| `person.blake_foster` | Blake Foster |
...
---
_Generated: 2025-09-28T16:01:51.029044-05:00_ EOF
