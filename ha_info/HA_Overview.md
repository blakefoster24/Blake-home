_Last Updated: 2026-09-17T02:00:00.360852-05:00_
...
| `input_datetime.home_timestamp` | **Home Timestamp** | 2026-09-16 19:37:56 | has_date=True, has_time=True |



  

| `input_datetime.last_door_open` | **Last Door Open** | 2026-09-16 19:56:25 | has_date=True, has_time=True |
...
<details><summary><b>Binary_sensor (78)</b></summary>
...
| `button.blake_foster30_gmail_com_set_backlight_late_for_work` | Blake.foster30@gmail.com set backlight late for work | 2026-09-16T15:29:52.089022+00:00 |
...
| `button.blake_foster30_gmail_com_video_mode_scene` | Blake.foster30@gmail.com video mode scene | 2026-09-16T15:34:39.375376+00:00 |
...
| `event.backup_automatic_backup` | Backup Automatic backup | 2026-09-16T10:45:36.058+00:00 |

| `event.bedroom_blake_s_echo_pop_voice_event` | Blake's Echo Pop Voice event | 2026-09-16T04:35:54.650+00:00 |

| `event.blake_s_echo_spot_voice_event` | Blake's Echo Spot Voice event | 2026-09-17T01:40:04.270+00:00 |

| `event.bthome_sensor_3370_button` | Motion 1 - Shelly Button | 2025-10-19T05:15:17.292+00:00 |

| `event.bthome_sensor_e125_button_1` | BTHome sensor E125 Button 1 | 2026-09-17T04:49:54.858+00:00 |

| `event.bthome_sensor_e125_button_2` | BTHome sensor E125 Button 2 | 2026-09-16T03:05:18.580+00:00 |

| `event.bthome_sensor_e125_button_3` | BTHome sensor E125 Button 3 | 2026-09-17T05:21:19.443+00:00 |

| `event.bthome_sensor_e125_button_4` | BTHome sensor E125 Button 4 | 2026-09-17T02:49:17.458+00:00 |
...
<details><summary><b>Light (13)</b></summary>
...
<details><summary><b>Media_player (14)</b></summary>
...
| `media_player.blake_s_echo_pop_2` | Blake's Echo Pop | idle |
...
| `notify.blake_s_echo_spot_speak` | Blake's Echo Spot Speak | 2026-09-16T13:54:07.600360+00:00 |

| `notify.blakes_iphone` | Blakes iPhone | 2026-09-16T15:28:58.292660+00:00 |
...
| `scene.all_lights` | All Lights | 2026-09-17T00:56:25.791966+00:00 |

| `scene.all_off` | All Off | 2026-09-16T14:00:47.342027+00:00 |

| `scene.bedroom_lights_off` | Bedroom Lights Off | 2026-09-17T02:49:10.914775+00:00 |

| `scene.dimmed` | Dimmed | 2026-09-16T03:05:18.715335+00:00 |

| `scene.full_lamp` | Full Lamp | 2026-09-17T04:49:58.234746+00:00 |

| `scene.goodnight_scene` | Goodnight | 2026-09-17T02:49:16.565209+00:00 |

| `scene.im_awake` | I’m Awake | 2026-09-02T18:02:35.234719+00:00 |

| `scene.lights_off_except_bedroom` | Lights off except bedroom | 2026-09-17T04:56:00.227469+00:00 |
...
| `scene.thermostat_away` | Thermostat Away | 2026-09-16T14:02:32.437739+00:00 |
...
| `select.blake_s_echo_spot_drop_in` | Blake's Echo Spot Drop In | home |
...
| `select.main_living_space_blake_s_echo_dot_drop_in` | Blake's Echo Dot Drop In | all |
...
<details><summary><b>Sensor (310)</b></summary>
...
| `sensor.a_expansion_attic_humidity` | A expansion attic Humidity | 63 |

| `sensor.a_expansion_attic_temperature` | A expansion attic Temperature | 77.72 |

| `sensor.akamatis_presence_sensor_b24c50_detection_distance` | Akamatis Presence Sensor b24c50 Detection Distance | 49.6062992125984 |
...
| `sensor.akamatis_presence_sensor_b24c50_moving_distance` | Akamatis Presence Sensor b24c50 Moving Distance | 55.9055118110236 |
...
| `sensor.akamatis_presence_sensor_b24c50_still_distance` | Akamatis Presence Sensor b24c50 Still Distance | 55.9055118110236 |
...
| `sensor.backup_last_attempted_automatic_backup` | Backup Last attempted automatic backup | 2026-09-16T10:41:08+00:00 |

| `sensor.backup_last_successful_automatic_backup` | Backup Last successful automatic backup | 2026-09-16T10:45:35+00:00 |

| `sensor.backup_next_scheduled_automatic_backup` | Backup Next scheduled automatic backup | 2026-09-17T10:31:33+00:00 |

| `sensor.bathroom_humidity` | Bathroom Humidity | 61.52 |
...
| `sensor.bathroom_temperature` | Bathroom Temperature | 69.908 |
...
| `sensor.bed_presence_bb8594_left_pressure` | Bed Pressure Sensor Left Pressure | 94.3997268676758 |

| `sensor.bed_presence_bb8594_right_pressure` | Bed Pressure Sensor Right Pressure | 86.7996673583984 |

| `sensor.bed_presence_bb8594_uptime` | Bed Pressure Sensor Uptime | 3614126.25 |
...
| `sensor.bedroom_ceiling_fan_energy_consumed` | Bedroom Ceiling Fan Energy consumed | 25.33427 |

| `sensor.blake_foster30_gmail_com_total_available_storage` | blake.foster30@gmail.com Total available storage | 5120.0 |

| `sensor.blake_foster30_gmail_com_used_storage` | blake.foster30@gmail.com Used storage | 279.471241375431 |
...
| `sensor.blakes_iphone_geocoded_location` | Blakes iPhone Geocoded Location | 1101 Watermark Dr
O'Fallon MO 63368
United States |

| `sensor.blakes_iphone_pressure` | Blakes iPhone Pressure | 14.5327819385078 |
...
| `sensor.bthome_sensor_3370_packet_id` | Motion 1 - Shelly Packet Id | 122 |

| `sensor.bthome_sensor_3370_signal_strength` | Motion 1 - Shelly Signal Strength | -70 |
...
| `sensor.c_expansion_attic_temperature` | C Expansion attic Temperature | 80.06 |
...
| `sensor.everything_presence_lite_922d28_target_1_angle` | Everything Presence Lite Target 1 Angle | -46.7788009643555 |

| `sensor.everything_presence_lite_922d28_target_1_distance` | Everything Presence Lite Target 1 Distance | 17.9368627352977 |
...
| `sensor.everything_presence_lite_922d28_target_1_x` | Everything Presence Lite Target 1 X | 1.18110236220472 |

| `sensor.everything_presence_lite_922d28_target_1_y` | Everything Presence Lite Target 1 Y | 17.8740157480315 |

| `sensor.everything_presence_lite_922d28_target_2_angle` | Everything Presence Lite Target 2 Angle | -6.08189725875854 |

| `sensor.everything_presence_lite_922d28_target_2_distance` | Everything Presence Lite Target 2 Distance | 126.341033695251 |
...
| `sensor.everything_presence_lite_922d28_target_2_x` | Everything Presence Lite Target 2 X | -75.8661417322835 |

| `sensor.everything_presence_lite_922d28_target_2_y` | Everything Presence Lite Target 2 Y | 100.984251968504 |
...
| `sensor.main_lights_this_month_s_consumption` | Main Lights This month's consumption | 1.207 |
...
| `sensor.nest_thermostat_temperature` | Nest Thermostat Temperature | 68.486 |
...
| `sensor.openweathermap_cloud_coverage_2` | OpenWeatherMap Cloud coverage | 2 |

| `sensor.openweathermap_condition_2` | OpenWeatherMap Condition | clear-night |

| `sensor.openweathermap_dew_point_2` | OpenWeatherMap Dew point temperature | 72.824 |

| `sensor.openweathermap_feels_like_temperature_2` | OpenWeatherMap Apparent temperature | 78.134 |

| `sensor.openweathermap_humidity_2` | OpenWeatherMap Humidity | 88 |
...
| `sensor.openweathermap_temperature_2` | OpenWeatherMap Temperature | 76.64 |
...
| `sensor.openweathermap_wind_bearing_2` | OpenWeatherMap Wind direction | 117 |
...
| `sensor.shelly_ceiling_fan_energy` | Bedroom Ceiling Fan Energy | 25.33427 |

| `sensor.shelly_ceiling_fan_power` | Bedroom Ceiling Fan Power | 0 |

| `sensor.shelly_ceiling_lights_energy` | Bedroom Ceiling Lights Energy | 23.008854 |

| `sensor.shelly_ceiling_lights_power` | Bedroom Ceiling Lights Power | 0 |

| `sensor.shelly_outlet_power` | Shelly Outlet Power | 1.3 |

| `sensor.shellyplugusg4_58e6c509a06c_current` | Shelly outlet Current | 0.024 |

| `sensor.shellyplugusg4_58e6c509a06c_energy` | Shelly outlet Energy | 8.769442 |
...
| `sensor.slzb_mr1_zigbee_chip_temp` | SLZB-MR1 Zigbee chip temp | 110.282 |

| `sensor.slzb_mr1_zigbee_chip_temp_2` | SLZB-MR1 Zigbee chip temp | 106.88 |

| `sensor.slzb_mr1_zigbee_type` | SLZB-MR1 Zigbee type | thread |

| `sensor.slzb_mr1_zigbee_type_2` | SLZB-MR1 Zigbee type | coordinator |

| `sensor.sun_next_dawn` | Sun Next dawn | 2026-09-17T11:19:16+00:00 |

| `sensor.sun_next_dusk` | Sun Next dusk | 2026-09-18T00:34:31+00:00 |

| `sensor.sun_next_midnight` | Sun Next midnight | 2026-09-18T05:56:53+00:00 |

| `sensor.sun_next_noon` | Sun Next noon | 2026-09-17T17:57:31+00:00 |

| `sensor.sun_next_rising` | Sun Next rising | 2026-09-17T11:46:25+00:00 |

| `sensor.sun_next_setting` | Sun Next setting | 2026-09-18T00:07:26+00:00 |
...
| `sensor.uptime` | Uptime | 2026-09-15T20:17:38+00:00 |
...
| `switch.blake_s_echo_dot_do_not_disturb_switch` | Blake's Echo Dot Do not disturb | off |
...
| `switch.blake_s_echo_pop_do_not_disturb_switch` | Blake's Echo Pop Do not disturb | off |
...
| `switch.blake_s_echo_spot_announcements` | Blake's Echo Spot Announcements | on |

| `switch.blake_s_echo_spot_communications` | Blake's Echo Spot Communications | on |
...
| `switch.main_living_space_blake_s_echo_dot_announcements` | Blake's Echo Dot Announcements | on |

| `switch.main_living_space_blake_s_echo_dot_communications` | Blake's Echo Dot Communications | on |
...
| `update.everything_presence_zone_configurator_update` | Everything Presence Zone Configurator Update | on |
...
| `update.opencode_update` | OpenCode Update | on |
