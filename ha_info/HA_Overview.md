_Last Updated: 2026-08-02T12:43:38.483903-05:00_
...
| `input_boolean.disable_toggle` | **Music Script Manual Disable** | off |  |
...
| `input_datetime.home_timestamp` | **Home Timestamp** | 2026-08-01 21:38:32 | has_date=True, has_time=True |



  

| `input_datetime.last_door_open` | **Last Door Open** | 2026-08-02 08:15:49 | has_date=True, has_time=True |
...
| `input_text.script_tracking` | **Script Tracking** |  |  |



| `input_text.script_variables` | **Script Variables** |  |  |
...
| `counter.door_stuck` | **Door Stuck** | 21 | min=none, max=none |
...
<details><summary><b>Binary_sensor (66)</b></summary>
...
<details><summary><b>Button (35)</b></summary>
...
| `button.blake_foster30_gmail_com_music_alarm` | Blake.foster30@gmail.com music alarm | unknown |

| `button.blake_foster30_gmail_com_set_backlight_late_for_work` | Blake.foster30@gmail.com set backlight late for work | unknown |
...
| `event.backup_automatic_backup` | Backup Automatic backup | 2026-08-02T09:54:32.974+00:00 |

| `event.bedroom_blake_s_echo_pop_voice_event` | Blake's Echo Pop Voice event | 2026-07-28T02:57:43.343+00:00 |

| `event.blake_s_echo_spot_voice_event` | Blake's Echo Spot Voice event | 2026-08-01T06:16:47.227+00:00 |

| `event.bthome_sensor_3370_button` | Motion 1 - Shelly Button | 2025-10-19T05:15:17.292+00:00 |

| `event.bthome_sensor_e125_button_1` | BTHome sensor E125 Button 1 | 2026-08-02T15:59:00.781+00:00 |

| `event.bthome_sensor_e125_button_2` | BTHome sensor E125 Button 2 | 2026-08-02T13:47:46.833+00:00 |

| `event.bthome_sensor_e125_button_3` | BTHome sensor E125 Button 3 | 2026-08-02T13:47:49.094+00:00 |

| `event.bthome_sensor_e125_button_4` | BTHome sensor E125 Button 4 | 2026-07-31T09:55:22.328+00:00 |

| `event.front_door_sensor_button` | Front Door Sensor Button | 2025-12-14T04:27:51.375+00:00 |

| `event.main_living_space_blake_s_echo_dot_voice_event` | Blake's Echo Dot Voice event | 2026-07-15T10:55:53.603+00:00 |
...
| `media_player.echo_test` | Echo test  | paused |
...
| `notify.blakes_iphone` | Blakes iPhone | 2026-08-02T17:43:33.315138+00:00 |
...
| `scene.all_lights` | All Lights | 2026-08-02T02:40:46.605463+00:00 |

| `scene.all_off` | All Off | 2026-08-01T23:10:00.227190+00:00 |

| `scene.bedroom_lights_off` | Bedroom Lights Off | 2026-07-25T05:07:26.908218+00:00 |

| `scene.dimmed` | Dimmed | 2026-08-02T13:47:44.229771+00:00 |

| `scene.full_lamp` | Full Lamp | 2026-08-02T13:47:46.995134+00:00 |

| `scene.goodnight_scene` | Goodnight | 2026-08-02T12:18:49.864831+00:00 |

| `scene.im_awake` | I’m Awake | 2026-07-21T07:54:53.478364+00:00 |

| `scene.lights_off_except_bedroom` | Lights off except bedroom | 2026-08-02T15:59:00.958887+00:00 |
...
| `scene.thermostat_away` | Thermostat Away | 2026-07-30T14:09:06.969071+00:00 |
...
<details><summary><b>Script (9)</b></summary>

| Entity ID | Name | State |
|---|---|---|

| `script.1785047221140` | Test | off |

| `script.1785047222016` | Test | off |
...
<details><summary><b>Select (20)</b></summary>
...
<details><summary><b>Sensor (287)</b></summary>
...
| `sensor.50_onn_roku_tv_active_app` | Bedroom TV Active app | Netflix |

| `sensor.50_onn_roku_tv_active_app_id` | Bedroom TV Active app ID | 12 |
...
| `sensor.akamatis_presence_sensor_b24c50_detection_distance` | Akamatis Presence Sensor b24c50 Detection Distance | 47.244094488189 |

| `sensor.akamatis_presence_sensor_b24c50_g0_move_energy` | Akamatis Presence Sensor b24c50 g0 move energy | 10.0 |

| `sensor.akamatis_presence_sensor_b24c50_g0_still_energy` | Akamatis Presence Sensor b24c50 g0 still energy | 0.0 |

| `sensor.akamatis_presence_sensor_b24c50_g1_move_energy` | Akamatis Presence Sensor b24c50 g1 move energy | 15.0 |

| `sensor.akamatis_presence_sensor_b24c50_g1_still_energy` | Akamatis Presence Sensor b24c50 g1 still energy | 0.0 |

| `sensor.akamatis_presence_sensor_b24c50_g2_move_energy` | Akamatis Presence Sensor b24c50 g2 move energy | 7.0 |

| `sensor.akamatis_presence_sensor_b24c50_g2_still_energy` | Akamatis Presence Sensor b24c50 g2 still energy | 0.0 |

| `sensor.akamatis_presence_sensor_b24c50_g3_move_energy` | Akamatis Presence Sensor b24c50 g3 move energy | 5.0 |

| `sensor.akamatis_presence_sensor_b24c50_g3_still_energy` | Akamatis Presence Sensor b24c50 g3 still energy | 5.0 |

| `sensor.akamatis_presence_sensor_b24c50_g4_move_energy` | Akamatis Presence Sensor b24c50 g4 move energy | 1.0 |

| `sensor.akamatis_presence_sensor_b24c50_g4_still_energy` | Akamatis Presence Sensor b24c50 g4 still energy | 4.0 |

| `sensor.akamatis_presence_sensor_b24c50_g5_move_energy` | Akamatis Presence Sensor b24c50 g5 move energy | 5.0 |
...
| `sensor.akamatis_presence_sensor_b24c50_g8_move_energy` | Akamatis Presence Sensor b24c50 g8 move energy | 6.0 |
...
| `sensor.akamatis_presence_sensor_b24c50_moving_distance` | Akamatis Presence Sensor b24c50 Moving Distance | 52.3622047244095 |
...
| `sensor.akamatis_presence_sensor_b24c50_still_distance` | Akamatis Presence Sensor b24c50 Still Distance | 52.3622047244095 |
...
| `sensor.aqara_fp300_humidity` | Aqara FP300 Humidity | 65.0 |

| `sensor.aqara_fp300_illuminance` | Aqara FP300 Illuminance | 7 |

| `sensor.aqara_fp300_target_distance` | Aqara FP300 Target distance | 0.0 |

| `sensor.aqara_fp300_temperature` | Aqara FP300 Temperature | 70.232 |

| `sensor.backup_backup_manager_state` | Backup Backup Manager state | idle |

| `sensor.backup_last_attempted_automatic_backup` | Backup Last attempted automatic backup | 2026-08-02T09:48:02+00:00 |

| `sensor.backup_last_successful_automatic_backup` | Backup Last successful automatic backup | 2026-08-02T09:54:32+00:00 |

| `sensor.backup_next_scheduled_automatic_backup` | Backup Next scheduled automatic backup | 2026-08-03T09:49:20+00:00 |

| `sensor.bathroom_humidity` | Bathroom Humidity | 61.33 |
...
| `sensor.bathroom_temperature` | Bathroom Temperature | 68.378 |
...
| `sensor.bed_presence_bb8594_left_pressure` | Bed Pressure Sensor Left Pressure | 92.4876480102539 |

| `sensor.bed_presence_bb8594_right_pressure` | Bed Pressure Sensor Right Pressure | 85.283935546875 |

| `sensor.bed_presence_bb8594_uptime` | Bed Pressure Sensor Uptime | 2053490.375 |
...
| `sensor.bedroom_ceiling_fan_energy_consumed` | Bedroom Ceiling Fan Energy consumed | 22.420773 |

| `sensor.blake_foster30_gmail_com_total_available_storage` | blake.foster30@gmail.com Total available storage | 5120.0 |

| `sensor.blake_foster30_gmail_com_used_storage` | blake.foster30@gmail.com Used storage | 282.595317961648 |
...
| `sensor.blake_s_echo_spot_illuminance` | Blake's Echo Spot Illuminance | 45.0 |
...
| `sensor.blakes_iphone_app_version` | Blakes iPhone App Version | 2026.7.1 |
...
| `sensor.blakes_iphone_distance` | Blakes iPhone Distance | 68 |
...
| `sensor.blakes_iphone_geocoded_location` | Blakes iPhone Geocoded Location | 1003 Watermark Dr
O'Fallon MO 63368
United States |

| `sensor.blakes_iphone_kiosk_brightness` | Blakes iPhone Kiosk Brightness | unavailable |

| `sensor.blakes_iphone_kiosk_volume` | Blakes iPhone Kiosk Volume | unavailable |

| `sensor.blakes_iphone_pressure` | Blakes iPhone Pressure | 14.3787518544889 |

| `sensor.blakes_iphone_ssid` | Blakes iPhone SSID | Not Connected |

| `sensor.blakes_iphone_steps` | Blakes iPhone Steps | 119 |
...
| `sensor.bthome_sensor_3370_illuminance` | Motion 1 - Shelly Illuminance | 24.0 |

| `sensor.bthome_sensor_3370_packet_id` | Motion 1 - Shelly Packet Id | 171 |

| `sensor.bthome_sensor_3370_signal_strength` | Motion 1 - Shelly Signal Strength | -58 |
...
| `sensor.c_expansion_attic_humidity` | C Expansion attic Humidity | 65 |

| `sensor.c_expansion_attic_temperature` | C Expansion attic Temperature | 76.46 |
...
| `sensor.everything_presence_lite_922d28_illuminance` | Everything Presence Lite Illuminance | 0.792322754859924 |
...
| `sensor.everything_presence_lite_922d28_target_1_angle` | Everything Presence Lite Target 1 Angle | 13.008508682251 |

| `sensor.everything_presence_lite_922d28_target_1_distance` | Everything Presence Lite Target 1 Distance | 182.599501722441 |
...
| `sensor.everything_presence_lite_922d28_target_1_x` | Everything Presence Lite Target 1 X | -151.377952755906 |

| `sensor.everything_presence_lite_922d28_target_1_y` | Everything Presence Lite Target 1 Y | 102.047244094488 |

| `sensor.everything_presence_lite_922d28_target_2_angle` | Everything Presence Lite Target 2 Angle | -2.60932683944702 |

| `sensor.everything_presence_lite_922d28_target_2_distance` | Everything Presence Lite Target 2 Distance | 121.070412463091 |
...
| `sensor.everything_presence_lite_922d28_target_2_x` | Everything Presence Lite Target 2 X | -78.4251968503937 |

| `sensor.everything_presence_lite_922d28_target_2_y` | Everything Presence Lite Target 2 Y | 92.2047244094488 |
...
| `sensor.front_door_sensor_illuminance` | Front Door Sensor Illuminance | 4.0 |
...
| `sensor.main_lights_this_month_s_consumption` | Main Lights This month's consumption | 0.013 |

| `sensor.main_lights_today_s_consumption` | Main Lights Today's consumption | 0.0 |

| `sensor.main_lights_voltage` | Main Lights Voltage | 122.0 |
...
| `sensor.nest_thermostat_temperature` | Nest Thermostat Temperature | 68.414 |
...
| `sensor.openweathermap_cloud_coverage_2` | OpenWeatherMap Cloud coverage | 5 |

| `sensor.openweathermap_condition_2` | OpenWeatherMap Condition | sunny |

| `sensor.openweathermap_dew_point_2` | OpenWeatherMap Dew point temperature | 68.45 |

| `sensor.openweathermap_feels_like_temperature_2` | OpenWeatherMap Apparent temperature | 79.502 |

| `sensor.openweathermap_humidity_2` | OpenWeatherMap Humidity | 69 |
...
| `sensor.openweathermap_temperature_2` | OpenWeatherMap Temperature | 79.502 |

| `sensor.openweathermap_uv_index_2` | OpenWeatherMap UV index | 8.74 |
...
| `sensor.openweathermap_wind_bearing_2` | OpenWeatherMap Wind direction | 69 |

| `sensor.openweathermap_wind_gust_2` | OpenWeatherMap Wind gust speed | 11.0057265569077 |

| `sensor.openweathermap_wind_speed_2` | OpenWeatherMap Wind speed | 8.9924838940587 |
...
| `sensor.shelly_ceiling_fan_energy` | Bedroom Ceiling Fan Energy | 22.420773 |

| `sensor.shelly_ceiling_fan_power` | Bedroom Ceiling Fan Power | 13.9 |

| `sensor.shelly_ceiling_lights_energy` | Bedroom Ceiling Lights Energy | 20.070075 |
...
| `sensor.shellyplugusg4_58e6c509a06c_energy` | Shelly outlet Energy | 6.850667 |
...
| `sensor.slzb_mr1_core_chip_temp` | SLZB-MR1 Core chip temp | 114.998 |

| `sensor.slzb_mr1_firmware_channel` | SLZB-MR1 Firmware channel | dev |

| `sensor.slzb_mr1_zigbee_chip_temp` | SLZB-MR1 Zigbee chip temp | 112.01 |

| `sensor.slzb_mr1_zigbee_chip_temp_2` | SLZB-MR1 Zigbee chip temp | 108.518 |

| `sensor.slzb_mr1_zigbee_type` | SLZB-MR1 Zigbee type | thread |

| `sensor.slzb_mr1_zigbee_type_2` | SLZB-MR1 Zigbee type | coordinator |

| `sensor.sun_next_dawn` | Sun Next dawn | 2026-08-03T10:36:21+00:00 |

| `sensor.sun_next_dusk` | Sun Next dusk | 2026-08-03T01:42:08+00:00 |

| `sensor.sun_next_midnight` | Sun Next midnight | 2026-08-03T06:09:00+00:00 |

| `sensor.sun_next_noon` | Sun Next noon | 2026-08-02T18:09:09+00:00 |

| `sensor.sun_next_rising` | Sun Next rising | 2026-08-03T11:06:20+00:00 |

| `sensor.sun_next_setting` | Sun Next setting | 2026-08-03T01:12:10+00:00 |
...
| `sensor.third_reality_inc_3rvs01031z_battery` | Vibration Sensor 1 Battery | 48.0 |
...
| `sensor.uptime` | Uptime | 2026-07-25T06:43:02+00:00 |
...
<details><summary><b>Switch (72)</b></summary>
...
<details><summary><b>Update (57)</b></summary>
...
| `update.slzb_mr1_zigbee_firmware` | SLZB-MR1 Zigbee firmware | on |
...
| `update.vertical_stack_in_card_update` | Vertical Stack In Card Update | on |
