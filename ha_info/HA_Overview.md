_Last Updated: 2026-09-22T02:00:00.501392-05:00_
...
| `input_boolean.dashboard_toggle` | **Dashboard Toggle** | off |  |
...
| `input_boolean.general_toggle_helper` | **General Toggle Helper** | off |  |
...
| `input_boolean.thermostat_automation_pause` | **Thermostat Automation pause** | off |  |
...
| `input_datetime.home_timestamp` | **Home Timestamp** | 2026-09-21 20:53:23 | has_date=True, has_time=True |



  

| `input_datetime.last_door_open` | **Last Door Open** | 2026-09-21 23:31:41 | has_date=True, has_time=True |
...
| `input_text.alarm_music` | **Alarm Music** | My soundtrack |  |
...
| `input_text.security_info` | **Security Info** |  |  |



| `input_text.template_tracking` | **Template Tracking** |  |  |
...
| `counter.counter_helper` | **Counter helper** | 0 | min=none, max=none |



  

| `counter.dryer_vibration_counter` | **Dryer Vibration Counter** | 0 | min=none, max=none |
...
<details><summary><b>Automation (19)</b></summary>
...
| `automation.browser_mod` | Browser Mod | on |
...
| `automation.light_automations` | Light Automations | on |

| `automation.living_room_lamp` | Living Room Lamp | on |

| `automation.nightly_github_sync` | Nightly GitHub sync | on |

| `automation.security` | Security | on |

| `automation.shelly_button_4` | Shelly Button 4 | on |

| `automation.shelly_button_45` | Shelly Button 4 | unavailable |

| `automation.thermostat` | Thermostat | on |

| `automation.washing_machine_dryer` | Washing Machine / Dryer | on |

| `automation.washing_machine_outlet` | washing machine outlet | on |
...
| `automation.workday_wakeup` | Workday Wakeup | on |
...
<details><summary><b>Binary_sensor (84)</b></summary>
...
| `binary_sensor.bathroom_light_overheated` | Bathroom Light Overheated | unavailable |
...
| `binary_sensor.blake_s_echo_dot_amazon_kids` | Blake's Echo Dot Amazon Kids | off |

| `binary_sensor.blake_s_echo_dot_connectivity` | Blake's Echo Dot Connectivity | on |

| `binary_sensor.blake_s_echo_pop_amazon_kids` | Blake's Echo Pop Amazon Kids | off |

| `binary_sensor.blake_s_echo_pop_connectivity` | Blake's Echo Pop Connectivity | on |

| `binary_sensor.blake_s_echo_spot_amazon_kids` | Blake's Echo Spot Amazon Kids | off |
...
| `binary_sensor.blakes_iphone_camera_motion` | Blakes iPhone Camera Motion | unavailable |

| `binary_sensor.blakes_iphone_focus` | Blakes iPhone Focus | unavailable |
...
| `binary_sensor.browser_mod_08b1fc4e_1ce0e908_browser_dark_mode` | Blake’s phone safari Browser dark mode | unavailable |

| `binary_sensor.browser_mod_08b1fc4e_1ce0e908_browser_fullykiosk` | Blake’s phone safari Browser FullyKiosk | unavailable |

| `binary_sensor.browser_mod_d005b7d1_a54d0a6b` | browser_mod_d005b7d1_a54d0a6b | unavailable |

| `binary_sensor.browser_mod_d005b7d1_a54d0a6b_browser_charging` | browser_mod_d005b7d1_a54d0a6b Browser charging | unavailable |

| `binary_sensor.browser_mod_d005b7d1_a54d0a6b_browser_dark_mode` | browser_mod_d005b7d1_a54d0a6b Browser dark mode | unavailable |

| `binary_sensor.browser_mod_d005b7d1_a54d0a6b_browser_fullykiosk` | browser_mod_d005b7d1_a54d0a6b Browser FullyKiosk | unavailable |

| `binary_sensor.browser_mod_fa0ef453_91cf654d` | Blake’s phone | unavailable |

| `binary_sensor.browser_mod_fa0ef453_91cf654d_browser_dark_mode` | Blake’s phone Browser dark mode | unavailable |

| `binary_sensor.browser_mod_fa0ef453_91cf654d_browser_fullykiosk` | Blake’s phone Browser FullyKiosk | unavailable |

| `binary_sensor.closet_light_cloud_connection` | Closet Light Cloud connection | on |

| `binary_sensor.closet_light_overheated` | Closet Light Overheated | unavailable |

| `binary_sensor.closet_motion` | Closet Motion | off |

| `binary_sensor.dryer` | Dryer | unavailable |
...
| `binary_sensor.fan_outlet_cloud_connection` | Fan Outlet Cloud connection | unavailable |

| `binary_sensor.front_door` | Front door | off |

| `binary_sensor.hlk_ld2410_ff00_motion` | HLK-LD2410_FF00 Motion | unavailable |

| `binary_sensor.hlk_ld2410_ff00_occupancy` | HLK-LD2410_FF00 Occupancy | unavailable |
...
| `binary_sensor.philips_rwl020_binary_input` | Hue Dimmer Binary input | unavailable |
...
| `binary_sensor.shellyplugusg4_58e6c509a06c_overcurrent` | Shelly outlet Overcurrent | off |

| `binary_sensor.shellyplugusg4_58e6c509a06c_overheating` | Shelly outlet Overheating | off |

| `binary_sensor.shellyplugusg4_58e6c509a06c_overpowering` | Shelly outlet Overpowering | off |

| `binary_sensor.shellyplugusg4_58e6c509a06c_overvoltage` | Shelly outlet Overvoltage | off |
...
<details><summary><b>Button (39)</b></summary>
...
| `button.bed_presence_bb8594_calibrate_left_occupied` | Bed Pressure Sensor Calibrate Left Occupied | unknown |

| `button.bed_presence_bb8594_calibrate_left_unoccupied` | Bed Pressure Sensor Calibrate Left Unoccupied | unknown |

| `button.bed_presence_bb8594_calibrate_right_occupied` | Bed Pressure Sensor Calibrate Right Occupied | unknown |

| `button.bed_presence_bb8594_calibrate_right_unoccupied` | Bed Pressure Sensor Calibrate Right Unoccupied | unknown |

| `button.bed_presence_bb8594_restart` | Bed Pressure Sensor Restart | unknown |

| `button.bedroom_blake_s_echo_pop_restart` | Blake's Echo Pop Restart | unknown |

| `button.blake_foster30_gmail_com_find_my_phone` | Blake.foster30@gmail.com find my phone | unknown |

| `button.blake_foster30_gmail_com_good_morning_by_alexa` | Blake.foster30@gmail.com Good Morning by Alexa | unknown |

| `button.blake_foster30_gmail_com_goodnight` | Blake.foster30@gmail.com Goodnight | unknown |

| `button.blake_foster30_gmail_com_i_m_awake` | Blake.foster30@gmail.com I'm awake | unknown |

| `button.blake_foster30_gmail_com_i_m_leaving` | Blake.foster30@gmail.com I'm Leaving | unknown |

| `button.blake_foster30_gmail_com_set_backlight_late_for_work` | Blake.foster30@gmail.com set backlight late for work | 2026-09-21T13:50:00.341371+00:00 |

| `button.blake_foster30_gmail_com_set_my_room` | Blake.foster30@gmail.com Set My Room | unknown |

| `button.blake_foster30_gmail_com_set_shower_volume` | Blake.foster30@gmail.com set shower volume | unknown |

| `button.blake_foster30_gmail_com_turn_the_ceiling_fan_off` | Blake.foster30@gmail.com turn the ceiling fan off | unknown |

| `button.blake_foster30_gmail_com_turn_the_ceiling_fan_on` | Blake.foster30@gmail.com turn the ceiling fan on | unknown |

| `button.blake_foster30_gmail_com_video_mode_scene` | Blake.foster30@gmail.com video mode scene | 2026-09-21T13:58:10.644460+00:00 |

| `button.blake_foster30_gmail_com_where_s_the_remote` | Blake.foster30@gmail.com where's the remote | unknown |

| `button.blake_s_echo_spot_restart` | Blake's Echo Spot Restart | unknown |
...
| `button.govee_to_mqtt_purge_caches` | Govee to MQTT Purge Caches | unavailable |

| `button.h6098_identify` | Bedroom Tv Backlight Identify | 2026-01-20T04:40:34.514908+00:00 |

| `button.hue_bulb_new_identify` | Bedroom Lamp Identify | unknown |

| `button.living_room_lamp_identify` | Living Room Lamp Identify | 2025-12-12T05:16:53.886398+00:00 |

| `button.main_living_space_blake_s_echo_dot_restart` | Blake's Echo Dot Restart | unknown |

| `button.nest_thermostat_identify` | Nest Thermostat Identify | unknown |

| `button.philips_rwl020_identify` | Hue Dimmer Identify | unavailable |

| `button.shelly_blu_rc_button_4_identify` | Shelly BLU RC Button 4  Identify | unknown |

| `button.shelly_device_reboot` | Shelly Device Restart | unknown |

| `button.shellyplugusg4_58e6c509a06c_restart` | Shelly outlet Restart | unknown |
...
<details><summary><b>Device_tracker (73)</b></summary>

| Entity ID | Name | State |
|---|---|---|

| `device_tracker.0102000000_c5b1` | 0102000000 C5B1 | unavailable |

| `device_tracker.4_26af` | 4 26AF | unavailable |

| `device_tracker.4_7e42` | 4 7E42 | unavailable |

| `device_tracker.4_eda2` | 4 EDA2 | unavailable |

| `device_tracker.blakes_iphone` | Blakes iPhone | home |

| `device_tracker.bleperipheralapp_4840` | BLEPeripheralApp 4840 | unavailable |

| `device_tracker.cube_gps_b5eb` | CUBE GPS B5EB | unavailable |

| `device_tracker.govee_h5074_1012` | Govee_H5074_1012 | unavailable |

| `device_tracker.gvh5075_822d` | GVH5075_822D | unavailable |

| `device_tracker.ipad` | iPad | home |

| `device_tracker.lw_ivu_ecf4` | LW  IVU ECF4 | unavailable |

| `device_tracker.niu_kqi_cf5e` | NIU KQi CF5E | unavailable |

| `device_tracker.niu_kqi_fcd3` | NIU KQi FCD3 | unavailable |

| `device_tracker.niukqi_1f3e` | NIUKQi 1F3E | unavailable |

| `device_tracker.rivian_phone_key_2060` | Rivian Phone Key 2060 | unavailable |

| `device_tracker.rivian_phone_key_3528` | Rivian Phone Key 3528 | unavailable |
...
| `device_tracker.rivian_phone_key_8e96` | Rivian Phone Key 8E96 | unavailable |

| `device_tracker.rivian_phone_key_9e27` | Rivian Phone Key 9E27 | unavailable |

| `device_tracker.rivian_phone_key_b167` | Rivian Phone Key B167 | unavailable |
...
| `device_tracker.rivian_phone_key_d403` | Rivian Phone Key D403 | unavailable |

| `device_tracker.rivian_phone_key_ec7f` | Rivian Phone Key EC7F | unavailable |

| `device_tracker.rivian_phone_key_ed6d` | Rivian Phone Key ED6D | unavailable |

| `device_tracker.rivian_phone_key_edb6` | Rivian Phone Key EDB6 | unavailable |
...
| `device_tracker.rivian_sensor_1_c68e` | Rivian Sensor 1 C68E | unavailable |
...
| `device_tracker.rivian_sensor_2_9210` | Rivian Sensor 2 9210 | unavailable |
...
| `device_tracker.rivian_sensor_3_adc1` | Rivian Sensor 3 ADC1 | unavailable |

| `device_tracker.rivian_sensor_3_bb9a` | Rivian Sensor 3 BB9A | unavailable |
...
| `device_tracker.rivian_sensor_4_7b97` | Rivian Sensor 4 7B97 | unavailable |

| `device_tracker.s02c178131a224f0cc_1887` | S02c178131a224f0cC 1887 | unavailable |
...
| `device_tracker.s441ac91699791ed5c_0bb9` | S441ac91699791ed5C 0BB9 | unavailable |
...
| `device_tracker.sa123e3d8d7a762bfc_08af` | Sa123e3d8d7a762bfC 08AF | unavailable |
...
| `device_tracker.t8d02_e3bb` | T8D02_E3BB | unavailable |

| `device_tracker.t8d02_e3bb_2` | T8D02_E3BB | unavailable |

| `device_tracker.telematic_390191_c5aa` | TELEMATIC-390191 C5AA | unavailable |

| `device_tracker.telematic_575072_ced2` | TELEMATIC-575072 CED2 | unavailable |

| `device_tracker.tirelinc_b3a6` | TireLinc B3A6 | unavailable |
...
<details><summary><b>Event (10)</b></summary>

| Entity ID | Name | State |
|---|---|---|

| `event.backup_automatic_backup` | Backup Automatic backup | 2026-09-21T10:11:56.037+00:00 |

| `event.bedroom_blake_s_echo_pop_voice_event` | Blake's Echo Pop Voice event | 2026-09-18T00:05:27.723+00:00 |

| `event.blake_s_echo_spot_voice_event` | Blake's Echo Spot Voice event | 2026-09-22T05:31:32.801+00:00 |

| `event.bthome_sensor_3370_button` | Motion 1 - Shelly Button | 2025-10-19T05:15:17.292+00:00 |

| `event.bthome_sensor_e125_button_1` | BTHome sensor E125 Button 1 | 2026-09-22T06:19:41.267+00:00 |

| `event.bthome_sensor_e125_button_2` | BTHome sensor E125 Button 2 | 2026-09-17T13:33:44.553+00:00 |

| `event.bthome_sensor_e125_button_3` | BTHome sensor E125 Button 3 | 2026-09-21T01:46:24.463+00:00 |

| `event.bthome_sensor_e125_button_4` | BTHome sensor E125 Button 4 | 2026-09-21T01:40:30.905+00:00 |

| `event.front_door_sensor_button` | Front Door Sensor Button | 2025-12-14T04:27:51.375+00:00 |

| `event.main_living_space_blake_s_echo_dot_voice_event` | Blake's Echo Dot Voice event | 2026-09-22T03:17:00.571+00:00 |
...
| `fan.bedroom_fan` | Fan | unavailable |
...
<details><summary><b>Light (14)</b></summary>
...
| `light.browser_mod_d005b7d1_a54d0a6b_screen` | browser_mod_d005b7d1_a54d0a6b Screen | unavailable |

| `light.browser_mod_fa0ef453_91cf654d_screen` | Blake’s phone Screen | unavailable |
...
<details><summary><b>Media_player (15)</b></summary>
...
| `media_player.blake_s_echo_dot_2` | Blake's Echo Dot | paused |
...
| `media_player.browser_mod_d005b7d1_a54d0a6b` | browser_mod_d005b7d1_a54d0a6b | unavailable |

| `media_player.browser_mod_fa0ef453_91cf654d` | Blake’s phone | unavailable |

| `media_player.living_room_tv` | Living Room TV | unavailable |

| `media_player.this_device_2` | This Device | idle |
...
<details><summary><b>Notify (9)</b></summary>
...
| `notify.blake_s_echo_pop_announce` | Blake's Echo Pop Announce | unavailable |
...
| `notify.blake_s_echo_spot_speak` | Blake's Echo Spot Speak | 2026-09-21T13:56:10.640022+00:00 |

| `notify.blakes_iphone` | Blakes iPhone | 2026-09-22T04:59:08.923759+00:00 |
...
| `number.bed_presence_bb8594_right_trigger_pressure` | Bed Pressure Sensor Right Trigger Pressure | 92.0 |
...
| `number.everything_presence_lite_922d28_occupancy_mask_1_begin_x` | Everything Presence Lite Occupancy Mask 1 Begin X | -500.0 |

| `number.everything_presence_lite_922d28_occupancy_mask_1_begin_y` | Everything Presence Lite Occupancy Mask 1 Begin Y | -300.0 |

| `number.everything_presence_lite_922d28_occupancy_mask_1_end_x` | Everything Presence Lite Occupancy Mask 1 End X | 500.0 |

| `number.everything_presence_lite_922d28_occupancy_mask_1_end_y` | Everything Presence Lite Occupancy Mask 1 End Y | 700.0 |
...
| `number.everything_presence_lite_922d28_zone_1_begin_x` | Everything Presence Lite Zone 1 Begin X | -2300.0 |

| `number.everything_presence_lite_922d28_zone_1_begin_y` | Everything Presence Lite Zone 1 Begin Y | 2000.0 |

| `number.everything_presence_lite_922d28_zone_1_end_x` | Everything Presence Lite Zone 1 End X | -1700.0 |

| `number.everything_presence_lite_922d28_zone_1_end_y` | Everything Presence Lite Zone 1 End Y | 3000.0 |
...
| `number.everything_presence_lite_922d28_zone_2_begin_x` | Everything Presence Lite Zone 2 Begin X | -1200.0 |

| `number.everything_presence_lite_922d28_zone_2_begin_y` | Everything Presence Lite Zone 2 Begin Y | 2000.0 |

| `number.everything_presence_lite_922d28_zone_2_end_x` | Everything Presence Lite Zone 2 End X | -700.0 |

| `number.everything_presence_lite_922d28_zone_2_end_y` | Everything Presence Lite Zone 2 End Y | 3000.0 |
...
| `number.hue_bulb_new_power_on_level` | Bedroom Lamp Power-on level | 254 |

| `number.hue_bulb_new_start_up_color_temperature` | Bedroom Lamp Start-up color temperature | 366 |
...
<details><summary><b>Remote (2)</b></summary>
...
| `remote.main_living_space_living_room_tv` | Living Room TV | unavailable |
...
| `scene.all_lights` | All Lights | 2026-09-22T01:56:08.833390+00:00 |

| `scene.all_off` | All Off | 2026-09-22T02:46:00.232442+00:00 |

| `scene.bedroom_lights_off` | Bedroom Lights Off | 2026-09-21T01:40:30.941028+00:00 |

| `scene.dimmed` | Dimmed | 2026-09-22T03:14:20.963266+00:00 |

| `scene.full_lamp` | Full Lamp | 2026-09-21T13:56:12.563298+00:00 |

| `scene.goodnight_scene` | Goodnight | 2026-09-21T06:27:53.151900+00:00 |

| `scene.im_awake` | I’m Awake | 2026-09-02T18:02:35.234719+00:00 |

| `scene.lights_off_except_bedroom` | Lights off except bedroom | 2026-09-22T06:40:00.484102+00:00 |

| `scene.night_light` | Night Light | 2025-09-26T00:17:04.739409+00:00 |

| `scene.set_my_room` | Set My Room | 2026-07-14T23:52:17.173031+00:00 |

| `scene.thermostat_away` | Thermostat Away | 2026-09-21T14:05:53.743831+00:00 |

| `scene.thermostat_ideal_evening` | Thermostat 68/70 | 2025-11-28T11:14:37.942932+00:00 |

| `scene.volume_scene_test` | Volume scene test | unknown |
...
| `script.helper_script` | Helper Script | off |
...
<details><summary><b>Select (22)</b></summary>
...
| `select.bedroom_blake_s_echo_pop_drop_in` | Blake's Echo Pop Drop In | unavailable |

| `select.blake_foster30_gmail_com_default_device` | Blake.foster30@gmail.com Default device | All Echo |

| `select.blake_s_echo_spot_drop_in` | Blake's Echo Spot Drop In | unavailable |
...
| `select.hue_bulb_new_power_on_behavior` | Bedroom Lamp Power-on behavior | On |

| `select.living_room_lamp_start_up_behavior` | Living Room Lamp Power-on behavior | PreviousValue |

| `select.main_living_space_blake_s_echo_dot_drop_in` | Blake's Echo Dot Drop In | unavailable |
...
<details><summary><b>Sensor (319)</b></summary>

| Entity ID | Name | State |
|---|---|---|

| `sensor.0102000000_c5b1_estimated_distance` | 0102000000 C5B1 Estimated distance | unavailable |

| `sensor.4_26af_estimated_distance` | 4 26AF Estimated distance | unavailable |

| `sensor.4_7e42_estimated_distance` | 4 7E42 Estimated distance | unavailable |

| `sensor.4_eda2_estimated_distance` | 4 EDA2 Estimated distance | unavailable |
...
| `sensor.a_expansion_attic_humidity` | A expansion attic Humidity | 69 |

| `sensor.a_expansion_attic_temperature` | A expansion attic Temperature | 71.96 |

| `sensor.akamatis_presence_sensor_b24c50_detection_distance` | Akamatis Presence Sensor b24c50 Detection Distance | 46.8503937007874 |
...
| `sensor.akamatis_presence_sensor_b24c50_moving_distance` | Akamatis Presence Sensor b24c50 Moving Distance | 53.5433070866142 |
...
| `sensor.akamatis_presence_sensor_b24c50_still_distance` | Akamatis Presence Sensor b24c50 Still Distance | 53.5433070866142 |

| `sensor.akamatis_presence_sensor_b24c50_still_energy` | Akamatis Presence Sensor b24c50 Still Energy | 100.0 |

| `sensor.apartment_apartment_fan_timer_timeout` | Apartment Fan timer timeout | unknown |

| `sensor.apartment_humidity` | Apartment Humidity | 62 |

| `sensor.apartment_temperature` | Apartment Temperature | 68.54 |
...
| `sensor.aqara_fp300_temperature` | Aqara FP300 Temperature | 68.378 |

| `sensor.backup_backup_manager_state` | Backup Backup Manager state | idle |

| `sensor.backup_last_attempted_automatic_backup` | Backup Last attempted automatic backup | 2026-09-21T10:06:43+00:00 |

| `sensor.backup_last_successful_automatic_backup` | Backup Last successful automatic backup | 2026-09-21T10:11:55+00:00 |

| `sensor.backup_next_scheduled_automatic_backup` | Backup Next scheduled automatic backup | 2026-09-22T10:27:44+00:00 |

| `sensor.bathroom_humidity` | Bathroom Humidity | 60.35 |

| `sensor.bathroom_humidity_derivative` | Temp & Humidity Bathroom Humidity Derivative | -0.1 |
...
| `sensor.bathroom_temperature` | Bathroom Temperature | 69.512 |
...
| `sensor.bed_presence_bb8594_left_pressure` | Bed Pressure Sensor Left Pressure | 94.3501434326172 |

| `sensor.bed_presence_bb8594_right_pressure` | Bed Pressure Sensor Right Pressure | 83.5623931884766 |

| `sensor.bed_presence_bb8594_uptime` | Bed Pressure Sensor Uptime | 4046136.5 |
...
| `sensor.bedroom_ceiling_fan_energy_consumed` | Bedroom Ceiling Fan Energy consumed | 25.567448 |

| `sensor.blake_foster30_gmail_com_total_available_storage` | blake.foster30@gmail.com Total available storage | 5120.0 |

| `sensor.blake_foster30_gmail_com_used_storage` | blake.foster30@gmail.com Used storage | 279.676187774166 |
...
| `sensor.blake_s_echo_pop_next_alarm_3` | Blake's Echo Pop Next alarm | unavailable |
...
| `sensor.blake_s_echo_pop_next_reminder_3` | Blake's Echo Pop Next reminder | unavailable |
...
| `sensor.blake_s_echo_pop_next_timer_3` | Blake's Echo Pop Next timer | unavailable |

| `sensor.blake_s_echo_spot_illuminance` | Blake's Echo Spot Illuminance | 35.0 |
...
| `sensor.blake_s_echo_spot_next_alarm_3` | Blake's Echo Spot Next alarm | unavailable |
...
| `sensor.blake_s_echo_spot_next_reminder_3` | Blake's Echo Spot Next reminder | unavailable |
...
| `sensor.blake_s_echo_spot_next_timer_3` | Blake's Echo Spot Next timer | unavailable |

| `sensor.blakes_iphone_activity` | Blakes iPhone Activity | Unknown |

| `sensor.blakes_iphone_app_version` | Blakes iPhone App Version | 2026.9.1 |

| `sensor.blakes_iphone_average_active_pace` | Blakes iPhone Average Active Pace | 1 |

| `sensor.blakes_iphone_battery_level` | Blakes iPhone Battery Level | 35 |
...
| `sensor.blakes_iphone_distance` | Blakes iPhone Distance | 0 |

| `sensor.blakes_iphone_floors_ascended` | Blakes iPhone Floors Ascended | 0 |

| `sensor.blakes_iphone_floors_descended` | Blakes iPhone Floors Descended | 0 |

| `sensor.blakes_iphone_geocoded_location` | Blakes iPhone Geocoded Location | 1109 Watermark Dr
O'Fallon MO 63368
United States |

| `sensor.blakes_iphone_pressure` | Blakes iPhone Pressure | 14.4827439168632 |
...
| `sensor.bleperipheralapp_4840_estimated_distance` | BLEPeripheralApp 4840 Estimated distance | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_height` | Blake’s phone safari Browser height | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_id` | Blake’s phone safari Browser ID | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_user` | Blake’s phone safari Browser user | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_useragent` | Blake’s phone safari Browser userAgent | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_visibility` | Blake’s phone safari Browser visibility | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_browser_width` | Blake’s phone safari Browser width | unavailable |

| `sensor.browser_mod_08b1fc4e_1ce0e908_panel` | Blake’s phone safari Panel | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_battery` | browser_mod_d005b7d1_a54d0a6b Browser battery | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_height` | browser_mod_d005b7d1_a54d0a6b Browser height | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_id` | browser_mod_d005b7d1_a54d0a6b Browser ID | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_path` | browser_mod_d005b7d1_a54d0a6b Browser path | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_user` | browser_mod_d005b7d1_a54d0a6b Browser user | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_useragent` | browser_mod_d005b7d1_a54d0a6b Browser userAgent | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_visibility` | browser_mod_d005b7d1_a54d0a6b Browser visibility | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_browser_width` | browser_mod_d005b7d1_a54d0a6b Browser width | unavailable |

| `sensor.browser_mod_d005b7d1_a54d0a6b_panel` | browser_mod_d005b7d1_a54d0a6b Panel | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_height` | Blake’s phone Browser height | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_id` | Blake’s phone Browser ID | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_user` | Blake’s phone Browser user | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_useragent` | Blake’s phone Browser userAgent | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_visibility` | Blake’s phone Browser visibility | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_browser_width` | Blake’s phone Browser width | unavailable |

| `sensor.browser_mod_fa0ef453_91cf654d_panel` | Blake’s phone Panel | unavailable |

| `sensor.bthome_sensor_3370_battery` | Motion 1 - Shelly Battery | 100 |

| `sensor.bthome_sensor_3370_illuminance` | Motion 1 - Shelly Illuminance | 11.0 |

| `sensor.bthome_sensor_3370_packet_id` | Motion 1 - Shelly Packet Id | 11 |

| `sensor.bthome_sensor_3370_signal_strength` | Motion 1 - Shelly Signal Strength | -63 |
...
| `sensor.c_expansion_attic_humidity` | C Expansion attic Humidity | 58 |

| `sensor.c_expansion_attic_temperature` | C Expansion attic Temperature | 75.2 |
...
| `sensor.cube_gps_b5eb_estimated_distance` | CUBE GPS B5EB Estimated distance | unavailable |
...
| `sensor.everything_presence_lite_922d28_occupancy_mask_1_target_count` | Everything Presence Lite Occupancy Mask 1 Target Count | 1.0 |
...
| `sensor.everything_presence_lite_922d28_target_1_angle` | Everything Presence Lite Target 1 Angle | -47.6573905944824 |

| `sensor.everything_presence_lite_922d28_target_1_distance` | Everything Presence Lite Target 1 Distance | 19.8147306667538 |
...
| `sensor.everything_presence_lite_922d28_target_1_y` | Everything Presence Lite Target 1 Y | 19.7244094488189 |

| `sensor.everything_presence_lite_922d28_target_2_angle` | Everything Presence Lite Target 2 Angle | -5.36058187484741 |

| `sensor.everything_presence_lite_922d28_target_2_distance` | Everything Presence Lite Target 2 Distance | 117.9963744156 |
...
| `sensor.everything_presence_lite_922d28_target_2_x` | Everything Presence Lite Target 2 X | -72.0472440944882 |

| `sensor.everything_presence_lite_922d28_target_2_y` | Everything Presence Lite Target 2 Y | 93.4251968503937 |
...
| `sensor.govee_h5074_1012_estimated_distance` | Govee_H5074_1012 Estimated distance | unavailable |

| `sensor.govee_to_mqtt_version` | Govee to MQTT Version | unavailable |

| `sensor.gvh5075_822d_estimated_distance` | GVH5075_822D Estimated distance | unavailable |
...
| `sensor.lw_ivu_ecf4_estimated_distance` | LW  IVU ECF4 Estimated distance | unavailable |
...
| `sensor.main_lights_this_month_s_consumption` | Main Lights This month's consumption | 1.33 |
...
| `sensor.nest_thermostat_temperature` | Nest Thermostat Temperature | 68.468 |
...
| `sensor.openweathermap_dew_point_2` | OpenWeatherMap Dew point temperature | 63.446 |

| `sensor.openweathermap_feels_like_temperature_2` | OpenWeatherMap Apparent temperature | 66.146 |

| `sensor.openweathermap_humidity_2` | OpenWeatherMap Humidity | 93 |
...
| `sensor.openweathermap_temperature_2` | OpenWeatherMap Temperature | 65.516 |
...
| `sensor.rivian_phone_key_3528_estimated_distance` | Rivian Phone Key 3528 Estimated distance | unavailable |

| `sensor.rivian_phone_key_35fe_estimated_distance` | Rivian Phone Key 35FE Estimated distance | unavailable |

| `sensor.rivian_phone_key_3a87_estimated_distance` | Rivian Phone Key 3A87 Estimated distance | unavailable |

| `sensor.rivian_phone_key_3d22_estimated_distance` | Rivian Phone Key 3D22 Estimated distance | unavailable |

| `sensor.rivian_phone_key_68c3_estimated_distance` | Rivian Phone Key 68C3 Estimated distance | unavailable |

| `sensor.rivian_phone_key_714f_estimated_distance` | Rivian Phone Key 714F Estimated distance | unavailable |

| `sensor.rivian_phone_key_77f5_estimated_distance` | Rivian Phone Key 77F5 Estimated distance | unavailable |

| `sensor.rivian_phone_key_7f97_estimated_distance` | Rivian Phone Key 7F97 Estimated distance | unavailable |

| `sensor.rivian_phone_key_88e3_estimated_distance` | Rivian Phone Key 88E3 Estimated distance | unavailable |

| `sensor.rivian_phone_key_8e96_estimated_distance` | Rivian Phone Key 8E96 Estimated distance | unavailable |

| `sensor.rivian_phone_key_9e27_estimated_distance` | Rivian Phone Key 9E27 Estimated distance | unavailable |

| `sensor.rivian_phone_key_b167_estimated_distance` | Rivian Phone Key B167 Estimated distance | unavailable |

| `sensor.rivian_phone_key_c28f_estimated_distance` | Rivian Phone Key C28F Estimated distance | unavailable |

| `sensor.rivian_phone_key_c3c8_estimated_distance` | Rivian Phone Key C3C8 Estimated distance | unavailable |

| `sensor.rivian_phone_key_c572_estimated_distance` | Rivian Phone Key C572 Estimated distance | unavailable |

| `sensor.rivian_phone_key_c7f3_estimated_distance` | Rivian Phone Key C7F3 Estimated distance | unavailable |

| `sensor.rivian_phone_key_d403_estimated_distance` | Rivian Phone Key D403 Estimated distance | unavailable |

| `sensor.rivian_phone_key_ec7f_estimated_distance` | Rivian Phone Key EC7F Estimated distance | unavailable |

| `sensor.rivian_phone_key_ed6d_estimated_distance` | Rivian Phone Key ED6D Estimated distance | unavailable |

| `sensor.rivian_phone_key_edb6_estimated_distance` | Rivian Phone Key EDB6 Estimated distance | unavailable |

| `sensor.rivian_phone_key_f289_estimated_distance` | Rivian Phone Key F289 Estimated distance | unavailable |

| `sensor.rivian_sensor_1_067a_estimated_distance` | Rivian Sensor 1 067A Estimated distance | unavailable |

| `sensor.rivian_sensor_1_6473_estimated_distance` | Rivian Sensor 1 6473 Estimated distance | unavailable |

| `sensor.rivian_sensor_1_c68e_estimated_distance` | Rivian Sensor 1 C68E Estimated distance | unavailable |

| `sensor.rivian_sensor_1_d795_estimated_distance` | Rivian Sensor 1 D795 Estimated distance | unavailable |

| `sensor.rivian_sensor_2_8ec7_estimated_distance` | Rivian Sensor 2 8EC7 Estimated distance | unavailable |

| `sensor.rivian_sensor_2_9210_estimated_distance` | Rivian Sensor 2 9210 Estimated distance | unavailable |

| `sensor.rivian_sensor_2_eca1_estimated_distance` | Rivian Sensor 2 ECA1 Estimated distance | unavailable |

| `sensor.rivian_sensor_3_aa31_estimated_distance` | Rivian Sensor 3 AA31 Estimated distance | unavailable |

| `sensor.rivian_sensor_3_adc1_estimated_distance` | Rivian Sensor 3 ADC1 Estimated distance | unavailable |

| `sensor.rivian_sensor_3_bb9a_estimated_distance` | Rivian Sensor 3 BB9A Estimated distance | unavailable |

| `sensor.rivian_sensor_3_d3ef_estimated_distance` | Rivian Sensor 3 D3EF Estimated distance | unavailable |

| `sensor.rivian_sensor_3_e53b_estimated_distance` | Rivian Sensor 3 E53B Estimated distance | unavailable |

| `sensor.rivian_sensor_4_0a2c_estimated_distance` | Rivian Sensor 4 0A2C Estimated distance | unavailable |

| `sensor.rivian_sensor_4_14f4_estimated_distance` | Rivian Sensor 4 14F4 Estimated distance | unavailable |

| `sensor.rivian_sensor_4_3d63_estimated_distance` | Rivian Sensor 4 3D63 Estimated distance | unavailable |

| `sensor.rivian_sensor_4_7b97_estimated_distance` | Rivian Sensor 4 7B97 Estimated distance | unavailable |
...
| `sensor.s5763cf7cddb7eef9c_7c8d_estimated_distance` | S5763cf7cddb7eef9C 7C8D Estimated distance | unavailable |

| `sensor.s58cdfccea0786690c_d4a2_estimated_distance` | S58cdfccea0786690C D4A2 Estimated distance | unavailable |

| `sensor.s97ba9994382d840bc_e454_estimated_distance` | S97ba9994382d840bC E454 Estimated distance | unavailable |

| `sensor.sa123e3d8d7a762bfc_08af_estimated_distance` | Sa123e3d8d7a762bfC 08AF Estimated distance | unavailable |

| `sensor.sbc4f3bc21b66bf73c_555f_estimated_distance` | Sbc4f3bc21b66bf73C 555F Estimated distance | unavailable |
...
| `sensor.sd78d075d9fbca645c_788d_estimated_distance` | Sd78d075d9fbca645C 788D Estimated distance | unavailable |

| `sensor.sdf631c51986d49cdc_295e_estimated_distance` | Sdf631c51986d49cdC 295E Estimated distance | unavailable |

| `sensor.sf6a4878a621b95aac_c58b_estimated_distance` | Sf6a4878a621b95aaC C58B Estimated distance | unavailable |

| `sensor.sfb57741ef118e66ec_4652_estimated_distance` | Sfb57741ef118e66eC 4652 Estimated distance | unavailable |

| `sensor.shelly_blu_rc_button_4_battery` | Shelly BLU RC Button 4  Battery | 100.0 |

| `sensor.shelly_ceiling_fan_energy` | Bedroom Ceiling Fan Energy | 25.567448 |

| `sensor.shelly_ceiling_fan_power` | Bedroom Ceiling Fan Power | 14.2 |

| `sensor.shelly_ceiling_lights_energy` | Bedroom Ceiling Lights Energy | 23.379486 |

| `sensor.shelly_ceiling_lights_power` | Bedroom Ceiling Lights Power | 0 |

| `sensor.shelly_outlet_power` | Shelly Outlet Power | 1.4 |

| `sensor.shellyplugusg4_58e6c509a06c_current` | Shelly outlet Current | 0.024 |

| `sensor.shellyplugusg4_58e6c509a06c_energy` | Shelly outlet Energy | 9.334304 |

| `sensor.shellyplugusg4_58e6c509a06c_energy_returned` | Shelly outlet Energy returned | 0.0 |

| `sensor.shellyplugusg4_58e6c509a06c_illuminance_level` | Shelly outlet Illuminance level | dark |
...
| `sensor.slzb_mr1_zigbee_chip_temp` | SLZB-MR1 Zigbee chip temp | 108.716 |

| `sensor.slzb_mr1_zigbee_chip_temp_2` | SLZB-MR1 Zigbee chip temp | 108.77 |

| `sensor.slzb_mr1_zigbee_type` | SLZB-MR1 Zigbee type | thread |

| `sensor.slzb_mr1_zigbee_type_2` | SLZB-MR1 Zigbee type | coordinator |

| `sensor.sun_next_dawn` | Sun Next dawn | 2026-09-22T11:23:49+00:00 |

| `sensor.sun_next_dusk` | Sun Next dusk | 2026-09-23T00:26:26+00:00 |

| `sensor.sun_next_midnight` | Sun Next midnight | 2026-09-23T05:55:07+00:00 |

| `sensor.sun_next_noon` | Sun Next noon | 2026-09-22T17:55:44+00:00 |

| `sensor.sun_next_rising` | Sun Next rising | 2026-09-22T11:50:52+00:00 |

| `sensor.sun_next_setting` | Sun Next setting | 2026-09-22T23:59:26+00:00 |

| `sensor.t8d02_e3bb_estimated_distance` | T8D02_E3BB Estimated distance | unavailable |

| `sensor.t8d02_e3bb_estimated_distance_2` | T8D02_E3BB Estimated distance | unavailable |

| `sensor.telematic_390191_c5aa_estimated_distance` | TELEMATIC-390191 C5AA Estimated distance | unavailable |

| `sensor.telematic_575072_ced2_estimated_distance` | TELEMATIC-575072 CED2 Estimated distance | unavailable |

| `sensor.third_reality_inc_3rths0224z_battery` | Temp & Humidity Battery | 100.0 |

| `sensor.third_reality_inc_3rvs01031z_battery` | Vibration Sensor 1 Battery | unavailable |

| `sensor.this_device_next_alarm_2` | This Device Next alarm | unknown |

| `sensor.this_device_next_reminder_2` | This Device Next reminder | unknown |

| `sensor.this_device_next_timer_2` | This Device Next timer | unknown |

| `sensor.tirelinc_b3a6_estimated_distance` | TireLinc B3A6 Estimated distance | unavailable |

| `sensor.uptime` | Uptime | 2026-09-17T17:17:50+00:00 |

| `sensor.vibration_2_third_reality_battery` | Vibration Sensor 2 Battery | unavailable |
...
<details><summary><b>Switch (74)</b></summary>
...
| `switch.bathroom_light_led` | Bathroom Light LED | on |

| `switch.bed_presence_bb8594_full_range` | Bed Pressure Sensor Full Range | off |

| `switch.bedroom_blake_s_echo_pop_announcements` | Blake's Echo Pop Announcements | unavailable |

| `switch.bedroom_blake_s_echo_pop_communications` | Blake's Echo Pop Communications | unavailable |

| `switch.bedroom_ceiling_fan` | Bedroom ceiling fan | on |

| `switch.bedroom_ceiling_lights` | Bedroom Ceiling Lights | off |

| `switch.bedroom_fan` | Fan | unavailable |
...
| `switch.blake_s_echo_pop_repeat_switch` | Blake's Echo Pop Repeat | off |

| `switch.blake_s_echo_pop_shuffle_switch` | Blake's Echo Pop Shuffle | on |

| `switch.blake_s_echo_spot_announcements` | Blake's Echo Spot Announcements | unavailable |

| `switch.blake_s_echo_spot_communications` | Blake's Echo Spot Communications | unavailable |

| `switch.blake_s_echo_spot_do_not_disturb` | Blake's Echo Spot Do not disturb | off |

| `switch.blake_s_echo_spot_do_not_disturb_switch` | Blake's Echo Spot Do not disturb | off |
...
| `switch.everything_presence_zone_configurator` | Everything Presence Zone Configurator | on |

| `switch.fan_outlet_led` | Fan Outlet LED | unavailable |
...
| `switch.main_living_space_blake_s_echo_dot_announcements` | Blake's Echo Dot Announcements | unavailable |

| `switch.main_living_space_blake_s_echo_dot_communications` | Blake's Echo Dot Communications | unavailable |
...
<details><summary><b>Todo (2)</b></summary>

| Entity ID | Name | State |
|---|---|---|

| `todo.blake_foster30_gmail_com_shopping_list` | Blake.foster30@gmail.com Shopping list | 0 |

| `todo.blake_foster30_gmail_com_to_do_list` | Blake.foster30@gmail.com To-do list | 0 |
...
<details><summary><b>Update (59)</b></summary>
...
| `update.bubble_card_tools_update` | Bubble Card Tools Update | off |

| `update.bubble_card_update` | Bubble Card Update | on |

| `update.button_card_update` | button-card Update | off |

| `update.c_a_f_e_update` | C.A.F.E. Update | unavailable |

| `update.clock_weather_card_update` | Clock Weather Card Update | off |
...
| `update.filebrowser_quantum_update` | FileBrowser Quantum Update | off |

| `update.fold_entity_row_update` | fold-entity-row Update | off |
...
| `update.hue_bulb_new_firmware` | Bedroom Lamp Firmware | unknown |
...
| `update.opencode_update` | OpenCode Update | off |
...
| `update.philips_rwl020_firmware` | Hue Dimmer Firmware | unavailable |

| `update.shelly_device_firmware` | Shelly Device Firmware | off |

| `update.shellyplugusg4_58e6c509a06c_firmware` | Shelly outlet Firmware | off |
...
| `update.state_switch_update` | state-switch Update | off |

| `update.template_entity_row_update` | template-entity-row Update | off |
...
| `update.third_reality_inc_3rvs01031z_firmware` | Vibration Sensor 1 Firmware | unavailable |
...
| `update.vibration_2_third_reality_firmware` | Vibration Sensor 2 Firmware | unavailable |
